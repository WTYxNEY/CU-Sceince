...
import './TabDepartment.css'
import TableDepartment from '../../Table/TableDepartment/TableDepartment'
          ...
          <div className="tab-content-tabs">
            ...
            <div className={toggleState === 1 ? "tab-active-content" : "tab-content"}>
              ...
              <div className="tab-table">
                <TableDepartment page={window.location.pathname} currentTab={toggleState} year={year} />
              </div>
