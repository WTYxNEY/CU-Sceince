...
import './TabBudget.css'
import TableBudget from '../../Table/TableBudget/TableBudget'
...
export default function TabBudget() {
  ...
  const renderDepartment = () => {
    return (
      <>
        <div className="budget-second-dropdown">
            <p style={{fontSize: '18px'}}>กลุ่มหมวด</p>
          <select >
            {tempDepart.map((dept) => {
              return (
  ...
  const renderDepartment2 = () => {
    return (
      <>
        <div className="budget-second-dropdown">
            <p style={{fontSize: '18px'}}>หมวด</p>
          <select style={{marginLeft: '33px'}}>
            {tempDepart.map((dept) => {
              return (
                <option value={dept}>{dept}</option>
              )
          ...
          <div className="tab-content-tabs">
            ...
            <div className={toggleState === 1 ? "tab-active-content" : "tab-content"}>
              ...
              <div className="tab-table">
                <TableBudget page={window.location.pathname} currentTab={toggleState} year={year} />
              </div>
